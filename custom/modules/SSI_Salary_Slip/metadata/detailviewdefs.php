    ...
    array (
      ...
      array (
        ...
        array (
          ...
          4 => 
          array (
            'customCode' => '<input type="button" class="button" onClick="javascript:window.location.href=\'index.php?entryPoint=generateSalarySlipEntry&uid={$fields.id.value}\'" value="{$MOD.LBL_PRINT_AS_PDF}">',
          ),
        ),
      ),
      'maxColumns' => '2',
